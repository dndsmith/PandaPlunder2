...
public class Pathfinder : MonoBehaviour 
{
    ...
    public void FindPath(Vector3 startPos, Vector3 endPos, Action<List<Vector3>> listMethod)
    {
        ...
        if (startNode != null)
        {
            //UnityEngine.Debug.Log("here in pathfinder...");
            //UnityEngine.Debug.Log(startPos.ToString());
            //UnityEngine.Debug.Log(endPos.ToString());
            if (endNode == null)
            {
               // UnityEngine.Debug.Log("shouldn't end up here");
                endPosValid = false;
                FindEndNode(endPos);
                if (endNode == null)
                {
            ...
            //UnityEngine.Debug.Log(startNode.ID);
            //UnityEngine.Debug.Log(endNode.ID);
            ...
            while (!endLoop)
            {
                //UnityEngine.Debug.Log(sortedOpenList.Count);
    ...
    {      
        ...
        //UnityEngine.Debug.Log(" closest neighbor is "+ x + " " + z);
        Node n = Map[x, z];
    ...
    {       
        ...
        //UnityEngine.Debug.Log(x.ToString() + " " + z.ToString());
    ...
    private void NeighbourCheck()
    {
        ...
        for (int i = y - 1; i < y + 2; i++)
        {
            for (int j = x - 1; j < x + 2; j++)
            {
                ...
                if (i > -1 && i < Map.GetLength(1) && j > -1 && j < Map.GetLength(0))
                {
                    //UnityEngine.Debug.Log("boundary check OK!");
                    //Dont check for the current node.
                    if (i != y || j != x)
                    {
                        //UnityEngine.Debug.Log("current node check OK!");
                        //Check the node is walkable
                        if (Map[j, i].walkable)
                        {
                            //UnityEngine.Debug.Log("walkable OK!");
                            //We do not recheck anything on the closed list
                            if (!OnClosedList(Map[j, i].ID))
                            {
                                //UnityEngine.Debug.Log("not already checked OK!");
                                //Check if we can move up or jump down!
                                //UnityEngine.Debug.Log(Map[j, i].yCoord - currentNode.yCoord);
                                ...
                                {
                                    //UnityEngine.Debug.Log("moveup/jumpdown OK!");
                                    //If it is not on the open list then add it to
                                    if (!OnOpenList(Map[j, i].ID))
                                    {
                                       // UnityEngine.Debug.Log("adding to open list");
                                    ...
                                    {
                                        //UnityEngine.Debug.Log("checking for cheaper path");
    ...
    private int BHGetLowest()
    {
        ...
        {
            //UnityEngine.Debug.Log("I think we get here");
            int ID = sortedOpenList[0].ID;
            sortedOpenList.RemoveAt(0);           
            return ID;
        }
